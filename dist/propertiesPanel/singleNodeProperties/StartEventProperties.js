...
export function StartEventProperties({ startEvent, }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs(PropertiesPanelHeaderFormSection, { title: startEvent["@_name"] || "Start event", icon: _jsx(EventDefinitionIcon, { variant: (_b = (_a = startEvent.eventDefinition) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.__$$element, filled: false, stroke: foregroundColor }), children: [_jsx(NameDocumentationAndId, { element: startEvent }), _jsx(Divider, { inset: { default: "insetXs" } }), _jsx(EventDefinitionProperties, { event: startEvent })] }), _jsx(OutputOnlyAssociationFormSection, { element: startEvent })] }));
}
