...
export function ExclusiveGatewayProperties({ exclusiveGateway, }) {
    return (_jsxs(PropertiesPanelHeaderFormSection, { title: exclusiveGateway["@_name"] || "Exclusive gateway", icon: _jsx(GatewayIcon, { variant: exclusiveGateway.__$$element, isIcon: true }), children: [_jsx(NameDocumentationAndId, { element: exclusiveGateway }), _jsx(Divider, { inset: { default: "insetXs" } }), _jsx(DefaultRouteSelector, { gateway: exclusiveGateway })] }));
}
