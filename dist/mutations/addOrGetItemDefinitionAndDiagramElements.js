...
export function addOrGetitemDefinitionAndDiagramElements({ definitions, }) {
    var _a, _b, _c, _d, _e;
    (_a = definitions.rootElement) !== null && _a !== void 0 ? _a : (definitions.rootElement = []);
    let itemDefinition = (_b = definitions.rootElement) === null || _b === void 0 ? void 0 : _b.filter((s) => s.__$$element === "itemDefinition")[0];
    if (!itemDefinition) {
        itemDefinition = {
            __$$element: "itemDefinition",
            "@_id": generateUuid(),
        };
        (_c = definitions.rootElement) === null || _c === void 0 ? void 0 : _c.push(itemDefinition);
    }
    let diagramElements;
...
//# sourceMappingURL=addOrGetItemDefinitionAndDiagramElements.js.map