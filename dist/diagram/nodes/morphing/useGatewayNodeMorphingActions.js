...
export function useGatewayNodeMorphingActions(gateway) {
    ...
    const morphingActions = useMemo(() => {
        return [
            {
                icon: _jsx(GatewayIcon, { variant: "parallelGateway", isIcon: true }),
                key: "1",
                title: "Parallel",
                id: "parallelGateway",
            ...
            {
                icon: _jsx(GatewayIcon, { variant: "exclusiveGateway", isIcon: true }),
                key: "2",
                title: "Exclusive",
                id: "exclusiveGateway",
            ...
            {
                icon: _jsx(GatewayIcon, { variant: "inclusiveGateway", isIcon: true }),
                key: "3",
                title: "Inclusive",
                id: "inclusiveGateway",
            ...
            {
                icon: _jsx(GatewayIcon, { variant: "eventBasedGateway", isIcon: true }),
                key: "4",
                title: "Event",
            ...
            {
                icon: _jsx(GatewayIcon, { variant: "complexGateway", isIcon: true }),
                key: "5",
                title: "Complex",
                id: "complexGateway",
