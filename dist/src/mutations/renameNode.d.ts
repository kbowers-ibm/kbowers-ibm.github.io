import { BPMN20__tDefinitions, BPMN20__tItemDefinition, BPMN20__tLane, BPMN20__tProcess, BPMN20__tTextAnnotation } from "@kie-tools/bpmn-marshaller/dist/schemas/bpmn-2_0/ts-gen/types";
...
export declare function updateItemDefinition({ definitions, newItemDefinition, id, }: {
    definitions: Normalized<BPMN20__tDefinitions>;
