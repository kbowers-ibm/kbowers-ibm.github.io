...
export declare const BPMN_OUTGOING_STRUCTURE: {
    node_startEvent: {
        nodes: ("node_textAnnotation" | "node_intermediateCatchEvent" | "node_intermediateThrowEvent" | "node_task" | "node_gateway")[];
        edges: ("edge_sequenceFlow" | "edge_association")[];
    };
    node_intermediateCatchEvent: {
        nodes: ("node_textAnnotation" | "node_endEvent" | "node_intermediateCatchEvent" | "node_intermediateThrowEvent" | "node_task" | "node_gateway")[];
        edges: ("edge_sequenceFlow" | "edge_association")[];
    };
...
export declare function getNodeTypeFromBpmnElement(bpmnElement: BpmnNodeElement): "node_textAnnotation" | "node_lane" | "node_dataObject" | "node_task" | "node_unknown" | undefined;
