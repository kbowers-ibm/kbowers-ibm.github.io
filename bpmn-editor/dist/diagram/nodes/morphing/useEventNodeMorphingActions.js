...
export function useEventNodeMorphingActions(event) {
    ...
    const morphingActions = useMemo(() => {
        return [
            ...
            {
                icon: _jsx(EventDefitnitionIcon, { stroke: foregroundColor, filled: filled, variant: "messageEventDefinition" }),
                key: "2",
                title: "Message",
            ...
            {
                icon: _jsx(EventDefitnitionIcon, { stroke: foregroundColor, filled: filled, variant: "timerEventDefinition" }),
                key: "3",
                title: "Timer",
            ...
            {
                icon: _jsx(EventDefitnitionIcon, { stroke: foregroundColor, filled: filled, variant: "errorEventDefinition" }),
                key: "4",
                title: "Error",
            ...
            {
                icon: _jsx(EventDefitnitionIcon, { stroke: foregroundColor, filled: filled, variant: "escalationEventDefinition" }),
                key: "5",
                title: "Escalation",
            ...
            {
                icon: _jsx(EventDefitnitionIcon, { stroke: foregroundColor, filled: filled, variant: "cancelEventDefinition" }),
                key: "6",
                title: "Cancelation",
            ...
            {
                icon: _jsx(EventDefitnitionIcon, { stroke: foregroundColor, filled: filled, variant: "compensateEventDefinition" }),
                key: "7",
                title: "Compensation",
            ...
            {
                icon: _jsx(EventDefitnitionIcon, { stroke: foregroundColor, filled: filled, variant: "conditionalEventDefinition" }),
                key: "8",
                title: "Conditional",
            ...
            {
                icon: _jsx(EventDefitnitionIcon, { stroke: foregroundColor, filled: filled, variant: "linkEventDefinition" }),
                key: "9",
                title: "Link",
            ...
            {
                icon: _jsx(EventDefitnitionIcon, { stroke: foregroundColor, filled: filled, variant: "signalEventDefinition" }),
                key: "0",
                title: "Signal",
