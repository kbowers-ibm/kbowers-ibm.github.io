...
function SignalEventSymbolSvg(_ref6) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("polygon", {
      points: `${leftUpperLeftPoint.x},${leftUpperLeftPoint.y} ${rightUpperLeftPoint.x},${rightUpperLeftPoint.y} ${centerUpperLeftPoint.x},${centerUpperLeftPoint.y} 
        ${leftUpperRightPoint.x}, ${leftUpperRightPoint.y} ${rightUpperRightPoint.x}, ${rightUpperRightPoint.y} ${centerUpperRightPoint.x}, ${centerUpperRightPoint.y}
        ${leftLowerLeftPoint.x}, ${leftLowerLeftPoint.y}
        ${rightLowerLeftPoint.x}, ${rightLowerLeftPoint.y}
        ${centerLowerLeftPoint.x}, ${centerLowerLeftPoint.y}
        ${leftLowerRightPoint.x}, ${leftLowerRightPoint.y}
        ${rightLowerRightPoint.x}, ${rightLowerRightPoint.y}
        ${centerLowerRightPoint.x}, ${centerLowerRightPoint.y}
