...
function SignalEventSymbolSvg(_ref6) {
  ...
  const leftUpperLeftPoint = {
    x: cx - arrowBaseWidth / 2 - 7,
    y: cy - arrowHeight / 2 + 2
  };
  const rightUpperLeftPoint = {
    x: cx - arrowBaseWidth / 2 + 5,
    y: cy - arrowHeight / 2 - 7
  };
  const centerUpperLeftPoint = {
    x: cx - arrowBaseWidth / 2 + 5,
    y: cy - arrowHeight / 2 - 7
  };
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("polygon", {
      points: `${leftUpperLeftPoint.x},${leftUpperLeftPoint.y} ${rightUpperLeftPoint.x},${rightUpperLeftPoint.y} ${leftUpperRightPoint.x},${leftUpperRightPoint.y} ${upperRightPointArrow.x}, ${upperRightPointArrow.y} ${arrowHead.x}, ${arrowHead.y} ${lowerRightPointArrow.x}, ${lowerRightPointArrow.y} ${lowerRightPoint.x}, ${lowerRightPoint.y}`,
      strokeWidth: 1.5,
      strokeLinejoin: "round",
      fill: filled ? stroke : "transparent",
      stroke: stroke
