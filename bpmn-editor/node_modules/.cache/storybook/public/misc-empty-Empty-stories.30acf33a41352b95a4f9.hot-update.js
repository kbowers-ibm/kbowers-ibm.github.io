...
function GatewayNodeSvg(__props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("polygon", {
      const: true,
      diamondPoints: true
    }), " [", x, ": cx, y: cy - size }, // top", x, ": cx + size, y: cy }, // right", x, ": cx, y: cy + size }, // bottom", x, ": cx - size, y: cy }, // left ]; points=", x, ": cx, y: cy - size }, // top", x, ": cx + size, y: cy }, // right", x, ": cx, y: cy + size }, // bottom", x, ": cx - size, y: cy }, // left } stroke=", stroke, "strokeWidth=", strokeWidth !== null && strokeWidth !== void 0 ? strokeWidth : 2, "fill=\"none\" // Ensures there is no black fill />", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("rect", {
      x: 8 + x,
      y: 8 + y,
