...
function TaskNodeSvg(__props) {
  ...
  const renderTopLeftCornerIcons = () => {
    const iconSize = 16;
    const icons = [];
    if (markers.has("user")) {
      icons.push((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(UserIcon, {
        x: x + 2,
        y: y + 2,
        width: iconSize,
        height: iconSize
    ...
    if (markers.has("script")) {
      icons.push((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(ScriptIcon, {
        x: x + iconSize + 4,
        y: y + 2,
        width: iconSize,
        height: iconSize
    ...
    if (markers.has("businessRule")) {
      icons.push((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(BusinessRuleIcon, {
        x: x + 2 * (iconSize + 4),
        y: y + 2,
        width: iconSize,
        height: iconSize
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("rect", {
      ...
      ry: "0",
      ...props
    }), renderTopLeftCornerIcons(), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(ActivityNodeIcons, {
      x: x,
      y: y,
      width: width,
      height: height,
...
function ParallelGatewaySvg(_ref) {
  let {
    stroke,
    strokeWidth,
    cx,
...
function ExclusiveGatewaySvg(_ref2) {
  let {
    stroke,
    strokeWidth,
    cx,
...
function InclusiveGatewaySvg(_ref3) {
  let {
    stroke,
    strokeWidth,
    cx,
...
function EventBasedGatewaySvg(_ref4) {
  let {
    stroke,
    strokeWidth,
    circleStrokeWidth,
...
function ComplexGatewaySvg(_ref5) {
  let {
    stroke,
    strokeWidth,
    cx,
...
function EventVariantSymbolSvg(_ref6) {
  let {
    variant,
    stroke,
    strokeWidth,
...
function MessageEventSymbolSvg(_ref7) {
  let {
    stroke,
    strokeWidth,
    isMorphingPanel,
...
function TimerEventSymbolSvg(_ref8) {
  let {
    stroke,
    strokeWidth,
    isMorphingPanel,
...
function ErrorEventSymbolSvg(_ref9) {
  let {
    stroke,
    strokeWidth,
    cx,
...
function EscalationEventSymbolSvg(_ref10) {
  let {
    stroke,
    strokeWidth,
    isMorphingPanel,
...
function CancelEventSymbolSvg(_ref11) {
  let {
    stroke,
    strokeWidth,
    cx,
...
function CompensationEventSymbolSvg(_ref12) {
  let {
    stroke,
    strokeWidth,
    cx,
...
function ConditionalEventSymbolSvg(_ref13) {
  let {
    stroke,
    strokeWidth,
    isMorphingPanel,
...
function LinkEventSymbolSvg(_ref14) {
  let {
    stroke,
    strokeWidth,
    isMorphingPanel,
...
function SignalEventSymbolSvg(_ref15) {
  let {
    stroke,
    strokeWidth,
    isMorphingPanel,
...
function ActivityNodeIcons(_ref16) {
  let {
    x,
    y,
    width,
